...
// GPU skinning fragment shader for converted YSM-GEO meshes (ported from the
// main project's bone_skin.fsh, itself ported from ModernYSM/OpenYSM):
// replicates Minecraft's entity shader semantics (cutout/translucent alpha
// modes, overlay texelFetch, lightmap texelFetch, linear fog) with the model
// texture on Sampler0, the overlay texture on Sampler1 and the lightmap on
// Sampler2.
