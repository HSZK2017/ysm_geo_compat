...
/**
 * GLSL compile/link helpers shared by the CPU skinning path (ported from the
 * main project's GpuShaderUtil, itself ported from ModernYSM's ShaderUtil).
 * Shaders live in the mod jar as classpath resources.
 */
