...
// GPU skinning fragment shader for converted YSM-GEO meshes - GLES 3.1
// variant for Android launchers. Same math as the desktop bone_skin.fsh
// (#version 430): model texture on Sampler0, overlay texture on Sampler1,
// lightmap on Sampler2, replicating Minecraft's entity shader semantics
